-- Fresh Supabase project ONLY. Same v1 tables; pg_trgm replaces unavailable pg_bigm index.
-- If v1 schema already exists, skip this file and run 002_shared_library.sql.
BEGIN;
...
CREATE INDEX prompt_chinese_gin ON prompt USING gin(search_text gin_trgm_ops) WHERE state='active';
